# -*- coding: utf-8 -*-
"""서울 열린데이터광장 「서울시 학교별·학급별 학생수 현황」(schoolInfoGrd, OA-22316)을
API로 전량 받아 tools/schoolInfoGrd_raw.json 으로 저장.
...
OUT = ROOT / "tools" / "schoolInfoGrd_raw.json"
SERVICE = "schoolInfoGrd"
PAGE_SIZE = 1000
